...
#[no_mangle] pub unsafe extern "C" fn rayzor_window_create(title: *const HaxeString, x: i32, y: i32, w: i32, h: i32, style: i32) -> *mut NativeWindow {
    let t = haxe_string_to_str(title); platform_create!(create, &t, x, y, w, h, style)
}
#[no_mangle] pub unsafe extern "C" fn rayzor_window_create_centered(title: *const HaxeString, w: i32, h: i32) -> *mut NativeWindow {
    let t = haxe_string_to_str(title); platform_create!(create_centered, &t, w, h)
}
#[no_mangle] pub unsafe extern "C" fn rayzor_window_poll_events(win: *mut NativeWindow) -> i32 { if win.is_null() { return 0; } if (*win).inner.poll_events() { 1 } else { 0 } }
#[no_mangle] pub unsafe extern "C" fn rayzor_window_is_key_down(win: *mut NativeWindow, key: i32) -> i32 { if win.is_null() { return 0; } if (*win).inner.is_key_down(key) { 1 } else { 0 } }

#[no_mangle] pub unsafe extern "C" fn rayzor_window_get_handle(win: *mut NativeWindow) -> *mut c_void {
    if win.is_null() { return std::ptr::null_mut(); }
    #[cfg(target_os = "macos")] { (*win).inner.ns_view }
    #[cfg(target_os = "linux")] { (*win).inner.window as *mut c_void }
    #[cfg(target_os = "windows")] { (*win).inner.hwnd }
    #[cfg(not(any(target_os = "macos", target_os = "linux", target_os = "windows")))] { std::ptr::null_mut() }
}
#[no_mangle] pub unsafe extern "C" fn rayzor_window_get_display_handle(win: *mut NativeWindow) -> *mut c_void {
    if win.is_null() { return std::ptr::null_mut(); }
    #[cfg(target_os = "linux")] { (*win).inner.display }
    #[cfg(not(target_os = "linux"))] { std::ptr::null_mut() }
}

#[no_mangle] pub unsafe extern "C" fn rayzor_window_get_width(win: *mut NativeWindow) -> i32 { if win.is_null() { return 0; } (*win).inner.width as i32 }
#[no_mangle] pub unsafe extern "C" fn rayzor_window_get_height(win: *mut NativeWindow) -> i32 { if win.is_null() { return 0; } (*win).inner.height as i32 }
#[no_mangle] pub unsafe extern "C" fn rayzor_window_get_x(win: *mut NativeWindow) -> i32 { if win.is_null() { return 0; } (*win).inner.get_position().0 }
#[no_mangle] pub unsafe extern "C" fn rayzor_window_get_y(win: *mut NativeWindow) -> i32 { if win.is_null() { return 0; } (*win).inner.get_position().1 }
#[no_mangle] pub unsafe extern "C" fn rayzor_window_was_resized(win: *mut NativeWindow) -> i32 { if win.is_null() { return 0; } if (*win).inner.resized { 1 } else { 0 } }
#[no_mangle] pub unsafe extern "C" fn rayzor_window_set_position(win: *mut NativeWindow, x: i32, y: i32) { if !win.is_null() { (*win).inner.set_position(x, y); } }
#[no_mangle] pub unsafe extern "C" fn rayzor_window_set_size(win: *mut NativeWindow, w: i32, h: i32) { if !win.is_null() { (*win).inner.set_size(w, h); } }
#[no_mangle] pub unsafe extern "C" fn rayzor_window_set_min_size(win: *mut NativeWindow, w: i32, h: i32) { if !win.is_null() { (*win).inner.set_min_size(w, h); } }
#[no_mangle] pub unsafe extern "C" fn rayzor_window_set_max_size(win: *mut NativeWindow, w: i32, h: i32) { if !win.is_null() { (*win).inner.set_max_size(w, h); } }

#[no_mangle] pub unsafe extern "C" fn rayzor_window_set_title(win: *mut NativeWindow, title: *const HaxeString) { if win.is_null() { return; } let t = haxe_string_to_str(title); (*win).inner.set_title(&t); }
#[no_mangle] pub unsafe extern "C" fn rayzor_window_set_fullscreen(win: *mut NativeWindow, fs: i32) { if !win.is_null() { (*win).inner.set_fullscreen(fs != 0); } }
#[no_mangle] pub unsafe extern "C" fn rayzor_window_set_visible(win: *mut NativeWindow, vis: i32) { if !win.is_null() { (*win).inner.set_visible(vis != 0); } }
#[no_mangle] pub unsafe extern "C" fn rayzor_window_set_floating(win: *mut NativeWindow, on_top: i32) { if !win.is_null() { (*win).inner.set_floating(on_top != 0); } }
#[no_mangle] pub unsafe extern "C" fn rayzor_window_set_opacity(win: *mut NativeWindow, opacity: f64) { if !win.is_null() { (*win).inner.set_opacity(opacity); } }

#[no_mangle] pub unsafe extern "C" fn rayzor_window_is_fullscreen(win: *mut NativeWindow) -> i32 { if win.is_null() { return 0; } if (*win).inner.is_fullscreen() { 1 } else { 0 } }
#[no_mangle] pub unsafe extern "C" fn rayzor_window_is_visible(win: *mut NativeWindow) -> i32 { if win.is_null() { return 0; } if (*win).inner.is_visible() { 1 } else { 0 } }
#[no_mangle] pub unsafe extern "C" fn rayzor_window_is_minimized(win: *mut NativeWindow) -> i32 { if win.is_null() { return 0; } if (*win).inner.is_minimized() { 1 } else { 0 } }
#[no_mangle] pub unsafe extern "C" fn rayzor_window_is_focused(win: *mut NativeWindow) -> i32 { if win.is_null() { return 0; } if (*win).inner.is_focused() { 1 } else { 0 } }

#[no_mangle] pub unsafe extern "C" fn rayzor_window_get_mouse_x(win: *mut NativeWindow) -> f64 { if win.is_null() { return 0.0; } (*win).inner.get_mouse_x() }
...
unsafe fn haxe_string_to_str(s: *const HaxeString) -> String {
    ...
    let hs = &*s;
    if hs.ptr.is_null() || hs.len == 0 { return String::new(); }
...
fn get_runtime_symbols() -> Vec<(&'static str, *const u8)> {
    vec![
        ...
        ("rayzor_window_set_position", rayzor_window_set_position as *const u8),
        ("rayzor_window_set_size", rayzor_window_set_size as *const u8),
        ("rayzor_window_set_min_size", rayzor_window_set_min_size as *const u8),
        ("rayzor_window_set_max_size", rayzor_window_set_max_size as *const u8),
        ("rayzor_window_set_title", rayzor_window_set_title as *const u8),
        ("rayzor_window_set_fullscreen", rayzor_window_set_fullscreen as *const u8),
        ("rayzor_window_set_visible", rayzor_window_set_visible as *const u8),
        ("rayzor_window_set_floating", rayzor_window_set_floating as *const u8),
        ("rayzor_window_set_opacity", rayzor_window_set_opacity as *const u8),
        ("rayzor_window_is_fullscreen", rayzor_window_is_fullscreen as *const u8),
        ("rayzor_window_is_visible", rayzor_window_is_visible as *const u8),
        ("rayzor_window_is_minimized", rayzor_window_is_minimized as *const u8),
        ("rayzor_window_is_focused", rayzor_window_is_focused as *const u8),
