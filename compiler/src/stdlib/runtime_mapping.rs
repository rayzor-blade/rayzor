...
impl StdlibMapping {
    ...
    pub fn new() -> Self {
        ...
        mapping.register_compress_methods();
        mapping.register_uncompress_methods();
        // WeakMap (delegates to ObjectMap — no GC means weak refs are regular refs)
        mapping.register_weakmap_methods();
        // SSL/TLS (sys.ssl.Socket, Certificate, Key, Digest)
        mapping.register_ssl_socket_methods();
        mapping.register_ssl_cert_methods();
        mapping.register_ssl_key_methods();
        mapping.register_ssl_digest_methods();
...
impl StdlibMapping {
    ...
    fn register_type_methods(&mut self) {
        ...
        let mappings = vec![
            ...
            map_method!(static "Type", "resolveClass" => "haxe_type_resolve_class", params: 1, returns: primitive,
                types: &[PtrVoid] => I64),
            // Type.resolveEnum(name:String):Enum<Dynamic>
            map_method!(static "Type", "resolveEnum" => "haxe_type_resolve_enum", params: 1, returns: primitive,
                types: &[PtrVoid] => I64),
            ...
            // Type.allEnums(e):Array<T> — parameterless constructors only
            map_method!(static "Type", "allEnums" => "haxe_type_all_enums", params: 1, returns: complex,
                types: &[I64] => PtrVoid),
        ];
    ...
    fn register_ereg_methods(&mut self) {
        ...
        let mappings = vec![
            ...
            map_method!(instance "EReg", "matchedRight" => "haxe_ereg_matched_right", params: 0, returns: primitive,
                types: &[PtrU8] => String),
            // matchedPos():{pos:Int, len:Int} — returns anon object with match position/length
            map_method!(instance "EReg", "matchedPos" => "haxe_ereg_matched_pos_anon", params: 0, returns: primitive,
                types: &[PtrU8] => PtrU8),
            ...
            map_method!(instance "EReg", "matchSub" => "haxe_ereg_match_sub", params: 3, returns: primitive,
                types: &[PtrU8, PtrString, I32, I32] => I32),
    ...
    fn register_compress_methods(&mut self) {
        use IrTypeDescriptor::*;
    ...
    fn register_uncompress_methods(&mut self) {
        use IrTypeDescriptor::*;
    ...
    fn register_weakmap_methods(&mut self) {
        use IrTypeDescriptor::*;
    ...
    fn register_ssl_socket_methods(&mut self) {
        use IrTypeDescriptor::*;
    ...
    fn register_ssl_cert_methods(&mut self) {
        use IrTypeDescriptor::*;
    ...
    fn register_ssl_key_methods(&mut self) {
        use IrTypeDescriptor::*;
    ...
    fn register_ssl_digest_methods(&mut self) {
        use IrTypeDescriptor::*;
